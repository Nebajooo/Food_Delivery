              ...
              <div className="card-body text-start">
                ...
                <p className="card-text">
                  <h5>
                    {" "}
                    Restaurant Name:{" "}
                    {product.foodItem && product.rest.restaurantName}
                  </h5>
                </p>
                <p className="card-text">
                  <h5>
                    {" "}
                    Cuisine: {product.foodItem && product.rest.cuisineType}
                  </h5>
                </p>
                <p className="card-text">
                ...
                <p className="card-text">
                  <h5>
                    {" "}
                    Description: {product.foodItem && product.rest.description}
                  </h5>
                </p>
                <p className="card-text">
                ...
                <p className="card-text">
                  <h5>
                    ...
                    <span
                      style={{
                        color:
                          product.rest && product.rest.status === "Open"
                            ? "green"
                            : "red",
                      }}>
                      {product.foodItem && product.rest.status}
                    </span>
                  </h5>
                </p>
                <p className="card-text">
